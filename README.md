...
<ol>
  ...
  <li><b>Run the command in project directory (autoBatWeb)<pre><code>python auto-BAT-Web/manage.py runmodwsgi --setup-only --port=80 --user abusr  --access-log --server-name=autobat.drfz.de --server-root=AutoBat-Webserver-80</code></pre>This will create a new folder called "AutoBat-Webserver-80" that stores the website settings, which we will configure in (<a apache="#getting-started"> Apache Webserver Settings</a>) section </b></li>
...
<h3 id="apache"> 🌀 Apache Webserver Settings</h2>
<ul>
<li><b>Go to the folder AutoBat-Webserver-80<pre><code>cd autoBatWeb/AutoBat-Webserver-80</code></pre></b></li>
  <li><b>Open http configuration file<pre><code>vim httpd.conf </code></pre></b></li>
  <li><b>To handle uploading large files, increase the upload limit value<pre><code>LimitRequestBody 21474836480</code></pre></b></li>
  <li><b>To handle functions that cause the webpage to take longer time to be loaded, increase timeout values<pre><code>Timeout 600 </code></pre></b></li>
